...
export function MovieListPage(props: MovieListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getMovies({
        relations: ['company', 'actor.count', 'director.count', 'review.count'],
        limit: params.pageSize,
        offset: params.pageNumber * params.pageSize,
        searchTerm: params.searchTerm,
        order: params.order,
        searchTermKeys: ['title.contains', 'movie_director.contains', 'genre.contains'],
        ...(params.filters || {}),
      }),
  ...
  const columns: ColumnType[] = [
    ...
    { id: 'movie_director', header: 'Movie Director', accessorKey: 'movie_director' },
    {
      id: 'release_date',
      header: 'Release Date',
    ...
    hasAccess('company', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('actor', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'actor',
          header: 'Actor',
          accessorKey: 'actor',
          cell: ({ row: { original: record } }: any) => record?._count?.actor,
        }
      : null,
    hasAccess('director', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'director',
          header: 'Director',
          accessorKey: 'director',
          cell: ({ row: { original: record } }: any) => record?._count?.director,
        }
      : null,
