...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['owner', 'end-user'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Actors', path: '/actors', entity: 'actor', service: AccessServiceEnum.PROJECT, icon: FiUserCheck },
    { name: 'Directors', path: '/directors', entity: 'director', service: AccessServiceEnum.PROJECT, icon: FiUserPlus },
