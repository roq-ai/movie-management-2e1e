  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Movie Management, your ultimate platform for streamlining movie collections and enhancing cinematic experience. Because every movie deserves to be managed meticulously."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1485846234645-a62644f84728?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxtb3ZpZXxlbnwwfHx8fDE2OTU0NjgxMzF8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Movie Management, your ultimate platform for streamlining movie collections and enhancing cinematic experience. Because every movie deserves to be managed meticulously.`}
            </Text>
            <Box
